...
def train(args, model, model_path):
    ...
    for e in range(args.epoch):
        ...
        torch.save(model.state_dict(), args.model_save_path + f'/base_{args.struc}_best_model.pth',
...
def main():
    ...
    parser.add_argument("--bert_config", default='./nezha-cn-base/config.json', type=str,
                        help="Path to save finetuned model")
    ...
    if args.do_train:
        ...
        for name in file_list:
            ...
            if os.path.isfile(model_path) and name.split('-')[0] == 'base':
